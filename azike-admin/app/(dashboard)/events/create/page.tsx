...
export default function CreateEventPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.title || !form.location || !form.start_datetime || !form.end_datetime) {
    ...
    try {
      const res = await fetch('/api/admin/events', {
        ...
        body: JSON.stringify({
          ...
          non_member_price: parseFloat(form.non_member_price),
  ...
  return (
    <div className="p-6 lg:p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Set up a new community event</p>
      </div>
